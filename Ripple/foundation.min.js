!function(a, b, c, d) {
    ...
    b.matchMedia = b.matchMedia || function(a) {
        ...
        init: function(a, b, c, d, e) {
            var f = [a, c, d, e], h = [];
            if (this.rtl = /rtl/i.test(g("html").attr("dir")), this.scope = a || this.scope, this.set_namespace()
                , b && "string" == typeof b&&!/reflow/i.test(b))this.libs.hasOwnProperty(b) && h.push(this.init_lib(b, f));
            else 
    ...
    Foundation.libs.abide = {
        ...
        validate: function(a, b, c) {
            ...
            for (var i = 0; e > i; i++)
                if (!d[i] && (h || c))
                    return g.focus_on_invalid && a[i].focus(), f.trigger("invalid"), this.S(a[i]).closest("[data-" + this.attr_name(!0) + "]").attr(this.invalid_attr, ""), !1;
            ...
            c(this.scope).off(".fndtn.accordion").on("click.fndtn.accordion", "[" + this.attr_name() + "] dd > a", function(d) {
                ...
                if (d.preventDefault(), c(this).closest("dl").is(e)
                    ...
                    if (i.toggleable && f.is(j))
                        return k.toggleClass(i.active_class, !1), f.toggleClass(i.active_class, !1);
    ...
    Foundation.libs.clearing = {
        ...
        center_and_label: function(a, b) {
            return this.rtl ? (a.css({
                ...
                marginRight : - (b.outerWidth() / 2), marginTop : - (a.outerHeight() / 2) - b.outerHeight()-10, left: "auto", right: "50%"
            })): (a.css({
        ...
        events: function() {
            ...
            d(this.scope).off(".dropdown").on("click.fndtn.dropdown", "[" + this.attr_name() + "]", function(b) {
                ...
                if (clearTimeout(c.timeout), b.data(c.data_attr()
                    ))var e = d("#" + b.data(c.data_attr())), f = b;
                else {
                    var e = b;
    ...
    Foundation.libs.equalizer = {
        ...
        equalize: function(b) {
            ...
            if (0 !== d.length && (f.before_height_change(), b.trigger("before-height-change"), d.height("inherit")
                , d.each(function() {
                var b = a(this);
                b.offset().top !== e && (c=!0)
            }), !c)) {
    ...
    Foundation.libs["magellan-expedition"] = {
        ...
        events: function() {
            ...
            c.set_expedition_position(), d(c.scope).off(".magellan").on("click.fndtn.magellan", "[" + c.add_namespace("data-magellan-arrival") + '] a[href^="#"]', function(b) {
                b.preventDefault();
                var d = a(this).closest("[" + c.attr_name() + "]"), e = (d.data("magellan-expedition-init"), this.hash.split("#").join("")), f = a("a[name='" + e + "']");
                0 === f.length && (f = a("#" + e));
                var g = f.offset().top;
        ...
        update_expedition_positions: function() {
            ...
            a("[" + this.attr_name() + "=fixed]", c.scope).each(function() {
                ...
                if (d >= e) {
                    ...
                    b.prev("[" + c.add_namespace("data-magellan-expedition-clone") + "]").remove(), b.attr("style", "")
            })
        },
    ...
    var d = function() {}, e = function(d, e) {
        ...
        m.cache = {}, m.slides = function() {
            ...
            if (m.build_markup(), e.timer && (m.cache.timer = m.create_timer()
                , Foundation.utils.image_loaded(this.slides().children("img"), m.cache.timer.start)), l = new g(e, n), p) {
            ...
            h.on("click", "." + e.next_class, m.next), h.on("click", "." + e.prev_class, m.prev), e.next_on_click && h.on("click", "[data-orbit-slide]", m.link_bullet), h.on("click", m.toggle_timer), e.swipe && n.on("touchstart.fndtn.orbit", function(a) {
                ...
                Math.abs(m.cache.delta_x) > 5 && (a.preventDefault(), a.stopPropagation()), m.cache.animating || requestAnimationFrame(function() {
                    if (a.touches || (a = a.originalEvent), !(a.touches.length > 1 || a.scale && 1 !== a.scale || (m.cache.delta_x = a.touches[0].pageX - m.cache.start_page_x, null === m.cache.is_scrolling && (m.cache.is_scrolling=!!(m.cache.is_scrolling || Math.abs(m.cache.delta_x) < Math.abs(a.touches[0].pageY - m.cache.start_page_y)
    ...
    Foundation.libs.slider = {
        ...
        calculate_position: function(b, c) {
            var d = this, e = a.extend({}, d.settings, d.data_options(b.parent())), f = (a.data(b[0], "handle_w"), a.data(b[0], "handle_o"), a.data(b[0], "bar_w")), g = a.data(b[0], "bar_o");
    ...
    Foundation.libs.tab = {
                ...
                if (e.deep_linking) {
                    ...
                    if ("" != f) {
                        ...
                        if (g.hasClass("content") && g.parent().hasClass("tab-content"))
                            b.toggle_active_tab(a("[" + b.attr_name() + "] > dd > a[href=" + f + "]").parent());
                        else {
                        ...
                        for (var i in b.default_tab_hashes)
                            b.toggle_active_tab(a("[" + b.attr_name() + "] > dd > a[href=" + b.default_tab_hashes[i] + "]").parent())
                }
            })
        },
        toggle_active_tab: function(c, e) {
            ...
            if (f(this).data(this.data_attr("tab-content")) && (i = "#" + f(this).data(this.data_attr("tab-content")).split("#")[1], j = f(i))
                , l.deep_linking) {
    ...
    Foundation.libs.tooltip = {
        ...
        reposition: function(b, c, d) {
            ...
            if (c.css("visibility", "hidden").show(), e = b.data("width")
                , f = c.children(".nub"), g = f.outerHeight(), h = f.outerHeight(), c.css(this.small() ? {
                width: "100%"
            } : {
                width: e ? e: "auto"
    ...
    Foundation.libs.topbar = {
        ...
        toggle: function(c) {
            var d = this;
            if (c)
                var e = d.S(c).closest("[" + this.attr_name() + "]");
            else 
                var e = d.S("[" + this.attr_name() + "]");
        ...
        events: function() {
            ...
            d(this.scope).off(".topbar").on("click.fndtn.topbar", "[" + this.attr_name() + "] .toggle-topbar", function(a) {
                ...
                if (c.breakpoint()) {
                    a.preventDefault();
                    var b = d(this), e = b.closest("[" + c.attr_name() + "]"), f = e.find("section, .section"), g = (b.next(".dropdown").outerHeight(), b.closest("li"));
                ...
                a.preventDefault();
                var b = d(this), e = b.closest("[" + c.attr_name() + "]"), f = e.find("section, .section"), g = (e.data(c.attr_name(!0) + "-init"), b.closest("li.moved")), h = g.parent();
            ...
            e.detach(), c.S(".has-dropdown>a", e).each(function() {
                ...
                if (!e.find(".title.back").length) {
                    if (d.mobile_show_parent_link && f && f.length > 1)
                        var g = a('<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li><li><a class="parent-link js-generated" href="' + f + '">' + b.text() + "</a></li>");
                    else 
                        var g = a('<li class="title back js-generated"><h5><a href="javascript:void(0)"></a></h5></li>');
